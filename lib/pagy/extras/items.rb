...
class Pagy
  ...
  module Frontend
    ...
    module UseItemsExtra
      ...
      def pagy_url_for(pagy, page,  deprecated_url=nil, only_path: true)
        only_path  = Pagy.deprecated_arg(:url, false, :only_path, only_path) if deprecated_url
        ...
        "#{request.base_url unless only_path}#{request.path}#{query_string}#{p_vars[:anchor]}"
      end
