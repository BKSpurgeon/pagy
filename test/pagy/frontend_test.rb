...
describe 'pagy/frontend' do
  ...
  describe '#pagy_url_for' do
    it 'renders basic url' do
      ...
      _(view.pagy_url_for(pagy, 5, only_path: false)).must_equal 'http://example.com:3000/foo?page=5'
    end
    it 'renders url with params' do
      ...
      _(view.pagy_url_for(pagy, 5, only_path: false)).must_equal "http://example.com:3000/foo?page=5&a=3&b=4"
    end
    it 'renders url with anchor' do
      ...
      _(view.pagy_url_for(pagy, 6, only_path: false)).must_equal 'http://example.com:3000/foo?page=6#anchor'
    end
    it 'renders url with params and anchor' do
      ...
      _(view.pagy_url_for(pagy, 5, only_path: false)).must_equal "http://example.com:3000/foo?page=5&a=3&b=4#anchor"
    end
  end
